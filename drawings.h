extern HFONT framefont, espfont, mFont, osFont, sFont, tFont, cFont, titleFont, subtitleFont, heading, o4Font_20, o4Font_11, o4Font_03;
...
public:
    ...
    void drawCrosshair1(int x, int y, Color col);
    void drawCrosshair2(int x, int y, Color col);
    void drawCrosshair3(int x, int y, Color col);
    void colorsTab(int X, int Y);
    void legitTab(int x, int y);
